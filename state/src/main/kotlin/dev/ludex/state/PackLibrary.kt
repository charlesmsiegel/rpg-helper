...
import dev.ludex.pack.PackMeta
import dev.ludex.pack.Packs
import dev.ludex.pack.Preflight
import dev.ludex.pack.ValidationReport
...
class PackLibrary(
    ...
    data class PackLimits(
        ...
        val content: dev.ludex.pack.PackLimits = dev.ludex.pack.PackLimits(),
    ) {
