...
import dev.ludex.pack.ViolationCode.CHUNK_KIND_INVALID
import dev.ludex.pack.ViolationCode.CHUNK_ORIGIN_INVALID
import dev.ludex.pack.ViolationCode.CLAIM_SPAN_INVERTED
import dev.ludex.pack.ViolationCode.CLAIM_SPAN_NOT_UTF8_BOUNDARY
import dev.ludex.pack.ViolationCode.CLAIM_SPAN_OUT_OF_RANGE
import dev.ludex.pack.ViolationCode.CLAIM_SPAN_PARTIAL
import dev.ludex.pack.ViolationCode.DANGLING_CHUNK_REFERENCE
import dev.ludex.pack.ViolationCode.DERIVATION_TARGET_MISSING
import dev.ludex.pack.ViolationCode.DERIVATION_TARGET_NOT_SOURCE
import dev.ludex.pack.ViolationCode.DERIVED_CHUNK_HAS_SOURCE_COLUMNS
import dev.ludex.pack.ViolationCode.DERIVED_CHUNK_NESTED
import dev.ludex.pack.ViolationCode.DERIVED_CHUNK_NO_DERIVATION
import dev.ludex.pack.ViolationCode.DUPLICATE_STABLE_KEY
import dev.ludex.pack.ViolationCode.NESTED_TEXT_MISMATCH
import dev.ludex.pack.ViolationCode.NESTING_CROSS_SOURCE
import dev.ludex.pack.ViolationCode.NONVERBATIM_CHILD_OF_VERBATIM_PARENT
import dev.ludex.pack.ViolationCode.NESTING_NOT_CONTAINED
import dev.ludex.pack.ViolationCode.NESTING_TOO_DEEP
import dev.ludex.pack.ViolationCode.PARENT_CHUNK_MISSING
import dev.ludex.pack.ViolationCode.SOURCE_CHUNK_HAS_DERIVATION
import dev.ludex.pack.ViolationCode.SOURCE_CHUNK_MISSING_CITATION
import dev.ludex.pack.ViolationCode.SOURCE_CHUNK_MISSING_SPAN
import dev.ludex.pack.ViolationCode.SPAN_INVERTED
import dev.ludex.pack.ViolationCode.SPAN_LENGTH_MISMATCH
