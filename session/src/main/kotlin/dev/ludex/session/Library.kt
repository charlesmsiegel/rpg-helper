...
class Library private constructor(
    ...
    companion object {
        ...
        private val supersessionCache = object {
            ...
            private var value: dev.ludex.retrieval.SupersededSet? = null

            @Synchronized
            fun get(
                fingerprint: List<CachedPack>,
                compute: () -> dev.ludex.retrieval.SupersededSet,
            ): dev.ludex.retrieval.SupersededSet {
                val cached = value
        ...
        fun open(paths: List<Path>): Library {
            val staging = Files.createTempDirectory("ludex-packs")
            return try {
